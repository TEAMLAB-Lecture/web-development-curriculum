...
## 소개
* 본 과정은 TEAMLAB의 웹 개발 커리큘럼 과정 개발 본입니다.
* 본 과정의 모든 자료는 Knowre의 신입 웹 개발자 교육을 위한 웹 개발 교육 커리큘럼인 [Knowre Web Development Curriculum](https://github.com/Knowre-Dev/WebDevCurriculum) 에서 fork 하여 작성되었습니다.
* 이 커리큘럼을 통해 신입 개발자들은 git, HTML, CSS, front-end JavaScript, node.js, MySQL, 그리고 더 나아가 선택된 몇 가지의 최신 웹 기술과 그 작동 원리에 대해 익히게 됩니다. 라고 Knowre 에서 말씀 주셨습니다.
